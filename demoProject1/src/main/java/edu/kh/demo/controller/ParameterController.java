...
public class ParameterController {
	...
	public String paramTest1(HttpServletRequest req) {
		...
		log.debug("inputAddress : " + inputAdress);
	 ...
	 * 
	 * [기본 작성법]
	 * @RequestParam("key") 자료형 매개변수형
	 * 
	 * [속성 추가 작성법]
	 * @RequestParame(value="name", required="false", defaultValue="1")
	 * 
	 * value : 전달받은 input 태그의 name 속성값 파라미터 필수 여부 지정(기본값 true)
	 * 
	 * required : 입력된 name 속성값 파라미터 필수 여부 지정(기본값 true)
	 * -> required = true 인 파라미터가 존재하지 않으면 400 Bad Request 에러 발생
	 * 
	 * 
	...
	public String paramTest3(
		...
		// -> 단, key(name 속성값) 중복되면 처음들어온 값 하나만 출력
		// -> 같은 name 속성 파라미터 String[], List로 저장 X
