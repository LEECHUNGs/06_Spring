...
public class FileConfig implements WebMvcConfigurer{
	...
	// 개별 파일당 최대 크기
	@Value("${spring.setvlet.multipart.max-file-size}")
	...
	private String boardResourceLoacation; // 연결될 서버 폴더 경로
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		// 클라이언트가 /myPage/file/** 패턴트로 이미지를 요청할 때
		...
		// file:///C: 는 파일의 시스템의 루트 디렉토리
		
		// file:// 은 URL 스킴(Scheme), 파일 시스템의 리소스
		// /C: 는 Windows 시스템이서 C 드라이브를 가리킴.
	...
	public MultipartConfigElement configElement() {
		...
		// 파일 업로드를 처리하는 데 사용되는 MultipartConfigElement 를 구성하고 반환
